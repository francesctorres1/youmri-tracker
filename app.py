...
<style>
    ...
    [data-testid="stExpander"] summary {{ background:#181A3A !important; }}
    [data-testid="stExpander"] summary, [data-testid="stExpander"] summary * {{ color:{CREMA} !important; }}
    [data-testid="stExpander"] details[open] summary {{ background:#181A3A !important; }}
